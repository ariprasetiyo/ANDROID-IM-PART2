...
//	private static final INT LISTENING_PORT_NO = 8956;
    ...
    {
    	/*
    	Realm configuration default
    	Create database with  name default default.realm
    	The location in Context.getFilesDir() or this.getApplicationContext()
    	*/
		/*
		...
		*/
		RealmConfiguration config2 = new RealmConfiguration.Builder(this.getApplicationContext())
				.name("default2")
				.schemaVersion(3)
				.deleteRealmIfMigrationNeeded()
				.build();
